...
describe Tablero do
  ...
  it "partido va 0-0, punto jugador2 marcador 0-15" 
  it "partido va 0-0, punto jugador2 es igual a 15" 
  ...
  # caso especial
  it "partido va 40-40, punto jugador2 marcador 0-A" 
  it "partido va 0-A, punto jugador2 marcador 0-0" 
  it "partido va 40-40, punto jugador1 marcador A-0" 
  it "partido va A-0, punto jugador1 marcador 0-0" 
